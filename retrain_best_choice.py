...
def train(args, epoch, train_loader, model, criterion, optimizer, choice, kchoice):
    model.train()
...
def validate(args, val_loader, model, criterion, choice, kchoice):
    model.eval()
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        train_loss, train_acc = train(args, epoch, train_loader, model, criterion, optimizer, choice, kchoice)
        scheduler.step()
        logging.info(
        ...
        val_loss, val_acc = validate(args, val_loader, model, criterion, choice, kchoice)
